...
for fn in "${fileList[@]}"; do 
    ...
    ${whisper_cpp_rootDir}/build/bin/whisper-cli   -l zh  -m  ${whisper_cpp_rootDir}/models/ggml-medium.bin  -f  ${work_dir}/${baseName}.wav > ${work_dir}/${baseName}_out_subtitles_cn.txt
